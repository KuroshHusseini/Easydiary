...
const publicDiary_put = async (res, req) => {
    ...
    const upPublicDiary = await publicDiaryEntryModel.updatePublicDayEntry(req.body);
...
const publicDiary_delete = async (req, res) => {
    ...
    const delePublicDiary = await publicDiaryEntryModel.deletePublicDiaryEntry(req.params.id);
